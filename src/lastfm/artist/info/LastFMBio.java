...
public class LastFMBio {
	...
	@JsonProperty private LastFMLinks links;
	...
	@JsonProperty("formationlist") private LastFMFormationList formationList;
	
	public void setLinks(LastFMLinks links){
		this.links = links;
	}
	public LastFMLinks getLinks(){
		return links;
	}
	...
	public void setFormationList(LastFMFormationList formationList){
		this.formationList = formationList;
	}
	public LastFMFormationList getFormationList(){
